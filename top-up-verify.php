...
include "config.php";
$amt= $_COOKIE["amount"];
$secret_key=$_SESSION["login_user"];
...
$userbal=$userblnc['value']+$amt;

mysqli_query($conn, "UPDATE balance SET value='$userbal' WHERE owner='$owner'");

}
$resf="
<h2 class='text-success'><b>Your Maaji wallet has been top up successfully</h2>
<hr>
<h5>
...
<head>
  ...
  <title>Top up Confirmation | Maaji </title>
    </head>
  <body>
  <style type="text/css">
