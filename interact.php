...
<body class="overflow-x-hidden">
    <div class="row overflow-x-hidden">
        <div id="main-section " class="col-md-3 col-lg-3 fixed overflow-y-auto h-full ">
            <section class="mt-0 mb-0 p-4 fixed z-10 bg-white dark:bg-green-800 top-header">
                <nav class="container p-3 mx-auto lg:flex lg:justify-between lg:items-center">
...
<footer class="bottom-nav shadow-teal-500 " style="width:100%">
        ...
        <div id="interaction" class="col-md-9 col-lg-9 overflow-x-hidden right-0 h-full fixed z-50 shadow-none">
                            ...
                            <div class="chat-head w-full">
                                <div class="flex justify-between items-center border-solid border-2 py-2 px-4 items-center">
                                    <div class="flex justify-center items-center">
                                        <a href="main.php"><button class="text-green-600 mr-4"><i class="fa fa-chevron-left"></i></button></a>
                                        <div class="profile-photo-container w-10 h-10 border-1 rounded-full mr-2 overflow-hidden"><img src="images/male-avatar.jpg" class="w-full" alt=""></div>
                            ...
                            <form method="post" action="msgsend.php" id="smsg">
                                ...
                                <div class="bg-gray-100">
                                    <div class="flex justify-center items-center p-4 border-gray-300 border-t-2">
                                        ...
                                        <input class="chat-input flex items-center h-10 w-5/6 px-3 text-sm border-2 border-gray-300 rounded-2xl mx-1" type="text" placeholder="Type your message…" name="msg">
                                        <button id="voiceNote" class="border-1 border-green-300 rounded-full h-10 w-10 mx-1 text-white bg-green-600 transition "><i class="fa fa-microphone"></i></button>
                                        <button id="send-money" class="send-transaction border-1 border-green-300 rounded-full h-10 w-auto pr-2 pl-2  mx-1 text-white bg-green-600 transition visible" type="button" data-modal-toggle="authentication-modal">Send&nbsp;Money</button>
                                        <button id="send-chat" class="send-transaction border-1 border-green-300 rounded-full h-10 w-10 mx-1 text-white bg-green-600 transition visually-hidden"><i class="fa fa-paper-plane"></i></button>
                                    </div>
                                </div>
                            </form>
                        ...
                        <div class="relative p-4 w-full max-w-md h-full md:h-auto">
                            ...
                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                <div class="flex justify-end p-2">
                                    <button type="button" id="modal-toggle" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-800 dark:hover:text-white" data-modal-toggle="authentication-modal">
                                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                            <path fill-rule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd"></path>
                                        </svg>
                                    </button>
                                </div>
                                <form class="px-6 pb-4 space-y-6 lg:px-8 sm:pb-6 xl:pb-8 w-full" action="transfer.php" id="trsf">
                                    <h3 class="text-xl font-medium text-gray-900 dark:text-dark">Send money to <?php
                                                                                                                echo $cfullname;
                                                                                                                ?>
                                    </h3>

                                    <input type="hidden" value="<?php echo $tfrom; ?>" name="tfrom">
                                    <input type="hidden" value="<?php echo $interactwith;
                                                                ?>" name="tto">
                                    <div id="err"></div>
                                    <div id="tresf"></div>
                                    <div>
                                        <label for="email" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-600">Amount</label>
                                        <input type="tel" name="amt" placeholder="1000" class="amount flex bg-gray-50 text-center text-2xl items-center justify-center border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2 dark:bg-gray-50 dark:border-gray-500 dark:placeholder-gray-400 dark:text-dark" required="">
                                    </div>
                                    <div>
                                        <label for="password" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-600">PIN</label>
                                        <div align="center">
                                            <table class="nav-columns w-full">
                                                <tr class="nav-icon-container justify-between  p-0">
                                                    <td class="p-2 pl-0">
                                                        <input type="password" id="pass1" placeholder="*" maxlength="1" name="pin1" class="flex bg-gray-50 text-center text-3xl items-center justify-center border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5 dark:bg-gray-50 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" required="">
                                                    </td>
                                                    <td class="p-2">
                                                        <input type="password" id="pass2" placeholder="*" maxlength="1" name="pin2" class="flex bg-gray-50 text-center text-3xl items-center justify-center border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5 dark:bg-gray-50 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" required="">
                                                    </td>
                                                    <td class="p-2">
                                                        <input type="password" id="pass3" placeholder="*" maxlength="1" name="pin3" class="flex bg-gray-50 text-center text-3xl items-center justify-center border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5 dark:bg-gray-50 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" required="">
                                                    </td>
                                                    <td class="p-2">
                                                        <input type="password" id="pass4" placeholder="*" maxlength="1" name="pin4" class="flex bg-gray-50 text-center text-3xl items-center justify-center border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5 dark:bg-gray-50 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" required="">
                                                    </td>
                                                </tr>
                                            </table>
                                        </div>
                                    </div>
                                    <button class="w-full text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800" type="submit">Send</button>
    ...
    <script>
        ...
        chatInput.addEventListener('keyup', (e) => {
            ...
            if (e.currentTarget.value.length > 0) {
                ...
                voiceNote.classList.add('visually-hidden');
            } else {
                ...
                voiceNote.classList.remove('visually-hidden');
        ...
        $("#trsf").on('submit', (function(e) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $("#tnx").animate({
                        scrollTop: $("#tnx").prop('scrollHeight')
                    }, "fast");
                },
                error: function(jqXHR, exception) {
                    console.log(jqXHR);
...
scrollDown();
    ...
    function hideModal(){
    var elem = document.querySelector("modal-toggle");
    return elem.click();
}    
